...
const store = new Vuex.Store({
  ...
  mutations: {
    setPlayingList: (state, playingList) => {
      state.playing.playingList = playingList;
    },
    setKeyWord: (state, keyWord) => {
      state.playing.keyWord = keyWord;
    },
    setIsShowFooter: (state, isShowFooter) => {
      state.playing.isShowFooter = isShowFooter;
    },
    setIsPlaying: (state, isPlaying) => {
      state.playing.isPlaying = isPlaying;
    },
    setCurrentTime: (state, currentTime) => {
      state.playing.currentTime = currentTime;
    },
    setMaxTime: (state, maxTime) => {
      state.playing.maxTime = maxTime;
    },
    setSongUrl: (state, songUrl) => {
      state.playing.songUrl = songUrl;
    },
    setIsShowAudio: (state, isShowAudio) => {
      state.playing.isShowAudio = isShowAudio;
    },
    setPlayIcon: (state, playIcon) => {
      state.playing.playIcon = playIcon;
    },
    setNowTime: (state, nowTime) => {
      state.playing.nowTime = nowTime;
    },
    setSongLyric: (state, songLyric) => {
      state.playing.songLyric = songLyric;
    },
    setSongId: (state, songId) => {
      state.playing.songId = songId;
    },
    setSongList: (state, songList) => {
      state.playing.songList = songList;
    },
    setSongName: (state, songName) => {
      state.playing.songName = songName;
    },
    setSongArtist: (state, songArtist) => {
      state.playing.songArtist = songArtist;
    },
  },
});
